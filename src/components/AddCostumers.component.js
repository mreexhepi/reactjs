...
function AddCostumersComponent(props){

  const validationSchema = yup.object({
    firstName: yup.string().required('This is a required Field'),
    lastName: yup.string().required('This is a required Field'),
    birthDate: yup.string()('Please enter a valid date').required('This is a required Field'),
...
export default AddCostumersComponent